            ...
            <div className="flex items-center space-x-8">
              {navItems.map((item) => (
                <motion.a
                  key={item.name}
                  href={item.href}
                  className="font-mono text-white/80 hover:text-orange-400 transition-all duration-300 text-sm event-horizon-hover relative group"
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 bg-black/95 backdrop-blur-sm">
          {navItems.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="block px-3 py-2 font-mono text-white/80 hover:text-orange-400 transition-colors text-sm"
