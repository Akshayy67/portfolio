...
interface ProfilePhotoProps {
  className?: string;
  size?: "sm" | "md" | "lg" | "xl";
  src?: string; // Add src prop to accept dynamic image paths
}

const ProfilePhoto: React.FC<ProfilePhotoProps> = ({
  className = "",
  size = "lg",
  src = "/profile-photo.jpg", // Default to profile-photo.jpg if no src is provided
}) => {
  ...
  const handlePhotoClick = () => {
    if (imageError) {
      ...
      alert(
        "Please add your profile photo to the 'public/profile-photo.jpg' file"
      );
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Profile image */}
        <motion.img
          src={src} // Use the dynamic src prop here
